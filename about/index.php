    ...
    <div class="centerwrapper">
        <div class="centerdiv">
            ...
            <?php
                ...
                </p></br><p>To use the system, individuals need to register the web application using their Bilkent mails . After the verification process is completed, users can login the system with their Bilkent University ID’s and passwords. The application provides different interfaces and features for different students,teachers and university administration.
